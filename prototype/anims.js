...
window.onload = function() {
  ...
  function create() {
      ...
      hero = game.add.sprite(50, 50, 'world', 'walk1');
      hero.anchor.set(0.5, 0.5);

      hero.animations.add('stand', Phaser.Animation.generateFrameNames('stand', 1,3, '', 0), 5, true);
      hero.animations.add('walk', Phaser.Animation.generateFrameNames('walk', 1,4, '', 0), 10, true);
      hero.animations.add('combo', Phaser.Animation.generateFrameNames('combo', 1,6, '', 0), 10, true);
