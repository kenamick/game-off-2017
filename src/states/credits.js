...
class Credits extends Renderer {
  ...
  create() {
    ...
    this.game.add.bitmapText(10, 50, Globals.bitmapFont, 'Artists: ', 12);
    this.game.add.bitmapText(this.game.world.width / 3, 65, Globals.bitmapFont, 'Petarov', 10);
    ...
    this.game.add.bitmapText(this.game.world.width / 3, 135, Globals.bitmapFont, 'Alexey, Carlos, Petarov', 10);
